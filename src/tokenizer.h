...
enum Lexer_Error_Kind {
	Lexer_Error_Kind_NONE,
	Lexer_Error_Kind_INVALID_TOKEN_KIND,
	Lexer_Error_Kind_COMMENT_BLOCK_NO_END,
	Lexer_Error_Kind_NO_MATCHING_PARENTHESIS
};
...
constexpr int LEXER_MAX_ERROR = 50;
...
struct Lexer {
	...
	String_Iter		at[3];
	bool			processing;
	Lexer_Error		error[LEXER_MAX_ERROR];
	int				error_count;
};
