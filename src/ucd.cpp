...
Ucd_Prop ucd_prop(uint32_t codepoint) {
	if (codepoint >= 0x0009 && codepoint <= 0x000D) return Ucd_Prop_WHITE_SPACE;
	if (codepoint == 0x0020) return Ucd_Prop_WHITE_SPACE;
	if (codepoint == 0x0085) return Ucd_Prop_WHITE_SPACE;
	if (codepoint == 0x00A0) return Ucd_Prop_WHITE_SPACE;
	if (codepoint == 0x1680) return Ucd_Prop_WHITE_SPACE;
	if (codepoint >= 0x2000 && codepoint <= 0x200A) return Ucd_Prop_WHITE_SPACE;
	if (codepoint == 0x2028) return Ucd_Prop_WHITE_SPACE;
	if (codepoint == 0x2029) return Ucd_Prop_WHITE_SPACE;
	if (codepoint == 0x202F) return Ucd_Prop_WHITE_SPACE;
	if (codepoint == 0x205F) return Ucd_Prop_WHITE_SPACE;
	if (codepoint == 0x3000) return Ucd_Prop_WHITE_SPACE;
	if (codepoint == 0x061C) return Ucd_Prop_BIDI_CONTROL;
	if (codepoint >= 0x200E && codepoint <= 0x200F) return Ucd_Prop_BIDI_CONTROL;
	if (codepoint >= 0x202A && codepoint <= 0x202E) return Ucd_Prop_BIDI_CONTROL;
	if (codepoint >= 0x2066 && codepoint <= 0x2069) return Ucd_Prop_BIDI_CONTROL;
	if (codepoint >= 0x200C && codepoint <= 0x200D) return Ucd_Prop_JOIN_CONTROL;
	if (codepoint == 0x002D) return Ucd_Prop_DASH;
	if (codepoint == 0x058A) return Ucd_Prop_DASH;
	if (codepoint == 0x05BE) return Ucd_Prop_DASH;
	if (codepoint == 0x1400) return Ucd_Prop_DASH;
	if (codepoint == 0x1806) return Ucd_Prop_DASH;
	if (codepoint >= 0x2010 && codepoint <= 0x2015) return Ucd_Prop_DASH;
	if (codepoint == 0x2053) return Ucd_Prop_DASH;
	if (codepoint == 0x207B) return Ucd_Prop_DASH;
	if (codepoint == 0x208B) return Ucd_Prop_DASH;
	if (codepoint == 0x2212) return Ucd_Prop_DASH;
	if (codepoint == 0x2E17) return Ucd_Prop_DASH;
	if (codepoint == 0x2E1A) return Ucd_Prop_DASH;
	if (codepoint >= 0x2E3A && codepoint <= 0x2E3B) return Ucd_Prop_DASH;
	if (codepoint == 0x2E40) return Ucd_Prop_DASH;
	if (codepoint == 0x301C) return Ucd_Prop_DASH;
	if (codepoint == 0x3030) return Ucd_Prop_DASH;
	if (codepoint == 0x30A0) return Ucd_Prop_DASH;
	if (codepoint >= 0xFE31 && codepoint <= 0xFE32) return Ucd_Prop_DASH;
	if (codepoint == 0xFE58) return Ucd_Prop_DASH;
	if (codepoint == 0xFE63) return Ucd_Prop_DASH;
	if (codepoint == 0xFF0D) return Ucd_Prop_DASH;
	if (codepoint == 0x10EAD) return Ucd_Prop_DASH;
	if (codepoint == 0x002D) return Ucd_Prop_HYPHEN;
	if (codepoint == 0x00AD) return Ucd_Prop_HYPHEN;
	if (codepoint == 0x058A) return Ucd_Prop_HYPHEN;
	if (codepoint == 0x1806) return Ucd_Prop_HYPHEN;
	if (codepoint >= 0x2010 && codepoint <= 0x2011) return Ucd_Prop_HYPHEN;
	if (codepoint == 0x2E17) return Ucd_Prop_HYPHEN;
	if (codepoint == 0x30FB) return Ucd_Prop_HYPHEN;
	if (codepoint == 0xFE63) return Ucd_Prop_HYPHEN;
	if (codepoint == 0xFF0D) return Ucd_Prop_HYPHEN;
	if (codepoint == 0xFF65) return Ucd_Prop_HYPHEN;
	if (codepoint == 0x0022) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0x0027) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0x00AB) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0x00BB) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0x2018) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0x2019) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0x201A) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint >= 0x201B && codepoint <= 0x201C) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0x201D) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0x201E) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0x201F) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0x2039) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0x203A) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0x2E42) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0x300C) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0x300D) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0x300E) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0x300F) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0x301D) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint >= 0x301E && codepoint <= 0x301F) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0xFE41) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0xFE42) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0xFE43) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0xFE44) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0xFF02) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0xFF07) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0xFF62) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0xFF63) return Ucd_Prop_QUOTATION_MARK;
	if (codepoint == 0x0021) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x002C) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x002E) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x003A && codepoint <= 0x003B) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x003F) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x037E) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x0387) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x0589) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x05C3) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x060C) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x061B) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x061E && codepoint <= 0x061F) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x06D4) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x0700 && codepoint <= 0x070A) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x070C) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x07F8 && codepoint <= 0x07F9) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x0830 && codepoint <= 0x083E) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x085E) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x0964 && codepoint <= 0x0965) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x0E5A && codepoint <= 0x0E5B) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x0F08) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x0F0D && codepoint <= 0x0F12) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x104A && codepoint <= 0x104B) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x1361 && codepoint <= 0x1368) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x166E) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x16EB && codepoint <= 0x16ED) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x1735 && codepoint <= 0x1736) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x17D4 && codepoint <= 0x17D6) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x17DA) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x1802 && codepoint <= 0x1805) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x1808 && codepoint <= 0x1809) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x1944 && codepoint <= 0x1945) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x1AA8 && codepoint <= 0x1AAB) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x1B5A && codepoint <= 0x1B5B) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x1B5D && codepoint <= 0x1B5F) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x1C3B && codepoint <= 0x1C3F) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x1C7E && codepoint <= 0x1C7F) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x203C && codepoint <= 0x203D) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x2047 && codepoint <= 0x2049) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x2E2E) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x2E3C) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x2E41) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x2E4C) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x2E4E && codepoint <= 0x2E4F) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x3001 && codepoint <= 0x3002) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0xA4FE && codepoint <= 0xA4FF) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0xA60D && codepoint <= 0xA60F) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0xA6F3 && codepoint <= 0xA6F7) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0xA876 && codepoint <= 0xA877) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0xA8CE && codepoint <= 0xA8CF) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0xA92F) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0xA9C7 && codepoint <= 0xA9C9) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0xAA5D && codepoint <= 0xAA5F) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0xAADF) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0xAAF0 && codepoint <= 0xAAF1) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0xABEB) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0xFE50 && codepoint <= 0xFE52) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0xFE54 && codepoint <= 0xFE57) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0xFF01) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0xFF0C) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0xFF0E) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0xFF1A && codepoint <= 0xFF1B) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0xFF1F) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0xFF61) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0xFF64) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x1039F) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x103D0) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x10857) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x1091F) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x10A56 && codepoint <= 0x10A57) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x10AF0 && codepoint <= 0x10AF5) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x10B3A && codepoint <= 0x10B3F) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x10B99 && codepoint <= 0x10B9C) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x10F55 && codepoint <= 0x10F59) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x11047 && codepoint <= 0x1104D) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x110BE && codepoint <= 0x110C1) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x11141 && codepoint <= 0x11143) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x111C5 && codepoint <= 0x111C6) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x111CD) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x111DE && codepoint <= 0x111DF) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x11238 && codepoint <= 0x1123C) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x112A9) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x1144B && codepoint <= 0x1144D) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x1145A && codepoint <= 0x1145B) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x115C2 && codepoint <= 0x115C5) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x115C9 && codepoint <= 0x115D7) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x11641 && codepoint <= 0x11642) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x1173C && codepoint <= 0x1173E) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x11944) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x11946) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x11A42 && codepoint <= 0x11A43) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x11A9B && codepoint <= 0x11A9C) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x11AA1 && codepoint <= 0x11AA2) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x11C41 && codepoint <= 0x11C43) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x11C71) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x11EF7 && codepoint <= 0x11EF8) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x12470 && codepoint <= 0x12474) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x16A6E && codepoint <= 0x16A6F) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x16AF5) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x16B37 && codepoint <= 0x16B39) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x16B44) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x16E97 && codepoint <= 0x16E98) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x1BC9F) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint >= 0x1DA87 && codepoint <= 0x1DA8A) return Ucd_Prop_TERMINAL_PUNCTUATION;
	if (codepoint == 0x005E) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x03D0 && codepoint <= 0x03D2) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x03D5) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x03F0 && codepoint <= 0x03F1) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x03F4 && codepoint <= 0x03F5) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2016) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x2032 && codepoint <= 0x2034) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2040) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x2061 && codepoint <= 0x2064) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x207D) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x207E) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x208D) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x208E) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x20D0 && codepoint <= 0x20DC) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x20E1) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x20E5 && codepoint <= 0x20E6) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x20EB && codepoint <= 0x20EF) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2102) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2107) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x210A && codepoint <= 0x2113) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2115) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x2119 && codepoint <= 0x211D) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2124) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2128) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2129) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x212C && codepoint <= 0x212D) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x212F && codepoint <= 0x2131) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x2133 && codepoint <= 0x2134) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x2135 && codepoint <= 0x2138) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x213C && codepoint <= 0x213F) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x2145 && codepoint <= 0x2149) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x2195 && codepoint <= 0x2199) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x219C && codepoint <= 0x219F) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x21A1 && codepoint <= 0x21A2) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x21A4 && codepoint <= 0x21A5) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x21A7) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x21A9 && codepoint <= 0x21AD) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x21B0 && codepoint <= 0x21B1) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x21B6 && codepoint <= 0x21B7) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x21BC && codepoint <= 0x21CD) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x21D0 && codepoint <= 0x21D1) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x21D3) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x21D5 && codepoint <= 0x21DB) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x21DD) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x21E4 && codepoint <= 0x21E5) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2308) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2309) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x230A) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x230B) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x23B4 && codepoint <= 0x23B5) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x23B7) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x23D0) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x23E2) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x25A0 && codepoint <= 0x25A1) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x25AE && codepoint <= 0x25B6) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x25BC && codepoint <= 0x25C0) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x25C6 && codepoint <= 0x25C7) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x25CA && codepoint <= 0x25CB) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x25CF && codepoint <= 0x25D3) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x25E2) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x25E4) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x25E7 && codepoint <= 0x25EC) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x2605 && codepoint <= 0x2606) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2640) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2642) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x2660 && codepoint <= 0x2663) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x266D && codepoint <= 0x266E) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x27C5) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x27C6) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x27E6) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x27E7) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x27E8) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x27E9) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x27EA) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x27EB) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x27EC) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x27ED) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x27EE) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x27EF) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2983) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2984) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2985) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2986) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2987) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2988) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2989) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x298A) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x298B) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x298C) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x298D) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x298E) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x298F) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2990) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2991) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2992) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2993) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2994) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2995) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2996) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2997) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x2998) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x29D8) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x29D9) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x29DA) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x29DB) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x29FC) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x29FD) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0xFE61) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0xFE63) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0xFE68) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0xFF3C) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0xFF3E) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D400 && codepoint <= 0x1D454) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D456 && codepoint <= 0x1D49C) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D49E && codepoint <= 0x1D49F) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1D4A2) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D4A5 && codepoint <= 0x1D4A6) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D4A9 && codepoint <= 0x1D4AC) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D4AE && codepoint <= 0x1D4B9) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1D4BB) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D4BD && codepoint <= 0x1D4C3) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D4C5 && codepoint <= 0x1D505) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D507 && codepoint <= 0x1D50A) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D50D && codepoint <= 0x1D514) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D516 && codepoint <= 0x1D51C) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D51E && codepoint <= 0x1D539) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D53B && codepoint <= 0x1D53E) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D540 && codepoint <= 0x1D544) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1D546) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D54A && codepoint <= 0x1D550) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D552 && codepoint <= 0x1D6A5) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D6A8 && codepoint <= 0x1D6C0) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D6C2 && codepoint <= 0x1D6DA) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D6DC && codepoint <= 0x1D6FA) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D6FC && codepoint <= 0x1D714) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D716 && codepoint <= 0x1D734) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D736 && codepoint <= 0x1D74E) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D750 && codepoint <= 0x1D76E) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D770 && codepoint <= 0x1D788) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D78A && codepoint <= 0x1D7A8) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D7AA && codepoint <= 0x1D7C2) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D7C4 && codepoint <= 0x1D7CB) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1D7CE && codepoint <= 0x1D7FF) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1EE00 && codepoint <= 0x1EE03) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1EE05 && codepoint <= 0x1EE1F) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1EE21 && codepoint <= 0x1EE22) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1EE24) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1EE27) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1EE29 && codepoint <= 0x1EE32) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1EE34 && codepoint <= 0x1EE37) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1EE39) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1EE3B) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1EE42) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1EE47) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1EE49) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1EE4B) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1EE4D && codepoint <= 0x1EE4F) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1EE51 && codepoint <= 0x1EE52) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1EE54) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1EE57) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1EE59) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1EE5B) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1EE5D) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1EE5F) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1EE61 && codepoint <= 0x1EE62) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1EE64) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1EE67 && codepoint <= 0x1EE6A) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1EE6C && codepoint <= 0x1EE72) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1EE74 && codepoint <= 0x1EE77) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1EE79 && codepoint <= 0x1EE7C) return Ucd_Prop_OTHER_MATH;
	if (codepoint == 0x1EE7E) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1EE80 && codepoint <= 0x1EE89) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1EE8B && codepoint <= 0x1EE9B) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1EEA1 && codepoint <= 0x1EEA3) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1EEA5 && codepoint <= 0x1EEA9) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x1EEAB && codepoint <= 0x1EEBB) return Ucd_Prop_OTHER_MATH;
	if (codepoint >= 0x0030 && codepoint <= 0x0039) return Ucd_Prop_HEX_DIGIT;
	if (codepoint >= 0x0041 && codepoint <= 0x0046) return Ucd_Prop_HEX_DIGIT;
	if (codepoint >= 0x0061 && codepoint <= 0x0066) return Ucd_Prop_HEX_DIGIT;
	if (codepoint >= 0xFF10 && codepoint <= 0xFF19) return Ucd_Prop_HEX_DIGIT;
	if (codepoint >= 0xFF21 && codepoint <= 0xFF26) return Ucd_Prop_HEX_DIGIT;
	if (codepoint >= 0xFF41 && codepoint <= 0xFF46) return Ucd_Prop_HEX_DIGIT;
	if (codepoint >= 0x0030 && codepoint <= 0x0039) return Ucd_Prop_ASCII_HEX_DIGIT;
	if (codepoint >= 0x0041 && codepoint <= 0x0046) return Ucd_Prop_ASCII_HEX_DIGIT;
	if (codepoint >= 0x0061 && codepoint <= 0x0066) return Ucd_Prop_ASCII_HEX_DIGIT;
	if (codepoint == 0x0345) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x05B0 && codepoint <= 0x05BD) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x05BF) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x05C1 && codepoint <= 0x05C2) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x05C4 && codepoint <= 0x05C5) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x05C7) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0610 && codepoint <= 0x061A) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x064B && codepoint <= 0x0657) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0659 && codepoint <= 0x065F) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0670) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x06D6 && codepoint <= 0x06DC) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x06E1 && codepoint <= 0x06E4) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x06E7 && codepoint <= 0x06E8) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x06ED) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0711) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0730 && codepoint <= 0x073F) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x07A6 && codepoint <= 0x07B0) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0816 && codepoint <= 0x0817) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x081B && codepoint <= 0x0823) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0825 && codepoint <= 0x0827) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0829 && codepoint <= 0x082C) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x08D4 && codepoint <= 0x08DF) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x08E3 && codepoint <= 0x08E9) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x08F0 && codepoint <= 0x0902) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0903) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x093A) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x093B) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x093E && codepoint <= 0x0940) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0941 && codepoint <= 0x0948) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0949 && codepoint <= 0x094C) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x094E && codepoint <= 0x094F) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0955 && codepoint <= 0x0957) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0962 && codepoint <= 0x0963) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0981) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0982 && codepoint <= 0x0983) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x09BE && codepoint <= 0x09C0) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x09C1 && codepoint <= 0x09C4) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x09C7 && codepoint <= 0x09C8) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x09CB && codepoint <= 0x09CC) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x09D7) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x09E2 && codepoint <= 0x09E3) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0A01 && codepoint <= 0x0A02) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0A03) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0A3E && codepoint <= 0x0A40) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0A41 && codepoint <= 0x0A42) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0A47 && codepoint <= 0x0A48) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0A4B && codepoint <= 0x0A4C) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0A51) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0A70 && codepoint <= 0x0A71) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0A75) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0A81 && codepoint <= 0x0A82) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0A83) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0ABE && codepoint <= 0x0AC0) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0AC1 && codepoint <= 0x0AC5) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0AC7 && codepoint <= 0x0AC8) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0AC9) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0ACB && codepoint <= 0x0ACC) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0AE2 && codepoint <= 0x0AE3) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0AFA && codepoint <= 0x0AFC) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0B01) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0B02 && codepoint <= 0x0B03) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0B3E) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0B3F) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0B40) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0B41 && codepoint <= 0x0B44) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0B47 && codepoint <= 0x0B48) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0B4B && codepoint <= 0x0B4C) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0B56) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0B57) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0B62 && codepoint <= 0x0B63) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0B82) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0BBE && codepoint <= 0x0BBF) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0BC0) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0BC1 && codepoint <= 0x0BC2) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0BC6 && codepoint <= 0x0BC8) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0BCA && codepoint <= 0x0BCC) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0BD7) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0C00) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0C01 && codepoint <= 0x0C03) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0C3E && codepoint <= 0x0C40) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0C41 && codepoint <= 0x0C44) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0C46 && codepoint <= 0x0C48) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0C4A && codepoint <= 0x0C4C) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0C55 && codepoint <= 0x0C56) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0C62 && codepoint <= 0x0C63) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0C81) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0C82 && codepoint <= 0x0C83) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0CBE) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0CBF) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0CC0 && codepoint <= 0x0CC4) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0CC6) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0CC7 && codepoint <= 0x0CC8) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0CCA && codepoint <= 0x0CCB) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0CCC) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0CD5 && codepoint <= 0x0CD6) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0CE2 && codepoint <= 0x0CE3) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0D00 && codepoint <= 0x0D01) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0D02 && codepoint <= 0x0D03) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0D3E && codepoint <= 0x0D40) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0D41 && codepoint <= 0x0D44) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0D46 && codepoint <= 0x0D48) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0D4A && codepoint <= 0x0D4C) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0D57) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0D62 && codepoint <= 0x0D63) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0D81) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0D82 && codepoint <= 0x0D83) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0DCF && codepoint <= 0x0DD1) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0DD2 && codepoint <= 0x0DD4) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0DD6) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0DD8 && codepoint <= 0x0DDF) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0DF2 && codepoint <= 0x0DF3) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0E31) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0E34 && codepoint <= 0x0E3A) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0E4D) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0EB1) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0EB4 && codepoint <= 0x0EB9) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0EBB && codepoint <= 0x0EBC) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0ECD) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0F71 && codepoint <= 0x0F7E) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x0F7F) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0F80 && codepoint <= 0x0F81) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0F8D && codepoint <= 0x0F97) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x0F99 && codepoint <= 0x0FBC) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x102B && codepoint <= 0x102C) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x102D && codepoint <= 0x1030) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1031) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1032 && codepoint <= 0x1036) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1038) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x103B && codepoint <= 0x103C) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x103D && codepoint <= 0x103E) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1056 && codepoint <= 0x1057) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1058 && codepoint <= 0x1059) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x105E && codepoint <= 0x1060) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1062 && codepoint <= 0x1064) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1067 && codepoint <= 0x106D) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1071 && codepoint <= 0x1074) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1082) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1083 && codepoint <= 0x1084) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1085 && codepoint <= 0x1086) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1087 && codepoint <= 0x108C) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x108D) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x108F) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x109A && codepoint <= 0x109C) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x109D) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1712 && codepoint <= 0x1713) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1732 && codepoint <= 0x1733) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1752 && codepoint <= 0x1753) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1772 && codepoint <= 0x1773) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x17B6) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x17B7 && codepoint <= 0x17BD) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x17BE && codepoint <= 0x17C5) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x17C6) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x17C7 && codepoint <= 0x17C8) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1885 && codepoint <= 0x1886) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x18A9) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1920 && codepoint <= 0x1922) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1923 && codepoint <= 0x1926) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1927 && codepoint <= 0x1928) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1929 && codepoint <= 0x192B) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1930 && codepoint <= 0x1931) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1932) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1933 && codepoint <= 0x1938) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1A17 && codepoint <= 0x1A18) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1A19 && codepoint <= 0x1A1A) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1A1B) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1A55) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1A56) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1A57) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1A58 && codepoint <= 0x1A5E) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1A61) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1A62) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1A63 && codepoint <= 0x1A64) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1A65 && codepoint <= 0x1A6C) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1A6D && codepoint <= 0x1A72) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1A73 && codepoint <= 0x1A74) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1ABF && codepoint <= 0x1AC0) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1B00 && codepoint <= 0x1B03) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1B04) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1B35) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1B36 && codepoint <= 0x1B3A) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1B3B) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1B3C) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1B3D && codepoint <= 0x1B41) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1B42) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1B43) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1B80 && codepoint <= 0x1B81) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1B82) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1BA1) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1BA2 && codepoint <= 0x1BA5) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1BA6 && codepoint <= 0x1BA7) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1BA8 && codepoint <= 0x1BA9) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1BAC && codepoint <= 0x1BAD) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1BE7) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1BE8 && codepoint <= 0x1BE9) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1BEA && codepoint <= 0x1BEC) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1BED) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1BEE) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1BEF && codepoint <= 0x1BF1) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1C24 && codepoint <= 0x1C2B) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1C2C && codepoint <= 0x1C33) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1C34 && codepoint <= 0x1C35) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1C36) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1DE7 && codepoint <= 0x1DF4) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x24B6 && codepoint <= 0x24E9) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x2DE0 && codepoint <= 0x2DFF) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xA674 && codepoint <= 0xA67B) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xA69E && codepoint <= 0xA69F) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xA802) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xA80B) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xA823 && codepoint <= 0xA824) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xA825 && codepoint <= 0xA826) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xA827) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xA880 && codepoint <= 0xA881) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xA8B4 && codepoint <= 0xA8C3) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xA8C5) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xA8FF) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xA926 && codepoint <= 0xA92A) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xA947 && codepoint <= 0xA951) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xA952) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xA980 && codepoint <= 0xA982) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xA983) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xA9B4 && codepoint <= 0xA9B5) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xA9B6 && codepoint <= 0xA9B9) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xA9BA && codepoint <= 0xA9BB) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xA9BC && codepoint <= 0xA9BD) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xA9BE && codepoint <= 0xA9BF) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xA9E5) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xAA29 && codepoint <= 0xAA2E) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xAA2F && codepoint <= 0xAA30) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xAA31 && codepoint <= 0xAA32) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xAA33 && codepoint <= 0xAA34) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xAA35 && codepoint <= 0xAA36) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xAA43) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xAA4C) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xAA4D) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xAA7B) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xAA7C) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xAA7D) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xAAB0) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xAAB2 && codepoint <= 0xAAB4) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xAAB7 && codepoint <= 0xAAB8) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xAABE) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xAAEB) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xAAEC && codepoint <= 0xAAED) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xAAEE && codepoint <= 0xAAEF) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xAAF5) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xABE3 && codepoint <= 0xABE4) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xABE5) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xABE6 && codepoint <= 0xABE7) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xABE8) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0xABE9 && codepoint <= 0xABEA) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0xFB1E) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x10376 && codepoint <= 0x1037A) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x10A01 && codepoint <= 0x10A03) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x10A05 && codepoint <= 0x10A06) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x10A0C && codepoint <= 0x10A0F) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x10D24 && codepoint <= 0x10D27) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x10EAB && codepoint <= 0x10EAC) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11000) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11001) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11002) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11038 && codepoint <= 0x11045) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11082) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x110B0 && codepoint <= 0x110B2) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x110B3 && codepoint <= 0x110B6) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x110B7 && codepoint <= 0x110B8) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11100 && codepoint <= 0x11102) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11127 && codepoint <= 0x1112B) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1112C) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1112D && codepoint <= 0x11132) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11145 && codepoint <= 0x11146) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11180 && codepoint <= 0x11181) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11182) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x111B3 && codepoint <= 0x111B5) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x111B6 && codepoint <= 0x111BE) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x111BF) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x111CE) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x111CF) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1122C && codepoint <= 0x1122E) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1122F && codepoint <= 0x11231) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11232 && codepoint <= 0x11233) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11234) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11237) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1123E) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x112DF) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x112E0 && codepoint <= 0x112E2) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x112E3 && codepoint <= 0x112E8) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11300 && codepoint <= 0x11301) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11302 && codepoint <= 0x11303) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1133E && codepoint <= 0x1133F) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11340) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11341 && codepoint <= 0x11344) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11347 && codepoint <= 0x11348) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1134B && codepoint <= 0x1134C) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11357) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11362 && codepoint <= 0x11363) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11435 && codepoint <= 0x11437) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11438 && codepoint <= 0x1143F) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11440 && codepoint <= 0x11441) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11443 && codepoint <= 0x11444) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11445) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x114B0 && codepoint <= 0x114B2) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x114B3 && codepoint <= 0x114B8) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x114B9) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x114BA) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x114BB && codepoint <= 0x114BE) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x114BF && codepoint <= 0x114C0) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x114C1) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x115AF && codepoint <= 0x115B1) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x115B2 && codepoint <= 0x115B5) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x115B8 && codepoint <= 0x115BB) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x115BC && codepoint <= 0x115BD) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x115BE) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x115DC && codepoint <= 0x115DD) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11630 && codepoint <= 0x11632) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11633 && codepoint <= 0x1163A) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1163B && codepoint <= 0x1163C) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1163D) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1163E) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11640) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x116AB) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x116AC) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x116AD) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x116AE && codepoint <= 0x116AF) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x116B0 && codepoint <= 0x116B5) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1171D && codepoint <= 0x1171F) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11720 && codepoint <= 0x11721) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11722 && codepoint <= 0x11725) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11726) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11727 && codepoint <= 0x1172A) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1182C && codepoint <= 0x1182E) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1182F && codepoint <= 0x11837) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11838) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11930 && codepoint <= 0x11935) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11937 && codepoint <= 0x11938) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1193B && codepoint <= 0x1193C) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11940) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11942) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x119D1 && codepoint <= 0x119D3) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x119D4 && codepoint <= 0x119D7) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x119DA && codepoint <= 0x119DB) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x119DC && codepoint <= 0x119DF) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x119E4) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11A01 && codepoint <= 0x11A0A) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11A35 && codepoint <= 0x11A38) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11A39) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11A3B && codepoint <= 0x11A3E) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11A51 && codepoint <= 0x11A56) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11A57 && codepoint <= 0x11A58) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11A59 && codepoint <= 0x11A5B) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11A8A && codepoint <= 0x11A96) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11A97) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11C2F) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11C30 && codepoint <= 0x11C36) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11C38 && codepoint <= 0x11C3D) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11C3E) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11C92 && codepoint <= 0x11CA7) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11CA9) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11CAA && codepoint <= 0x11CB0) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11CB1) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11CB2 && codepoint <= 0x11CB3) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11CB4) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11CB5 && codepoint <= 0x11CB6) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11D31 && codepoint <= 0x11D36) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11D3A) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11D3C && codepoint <= 0x11D3D) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11D3F && codepoint <= 0x11D41) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11D43) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11D47) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11D8A && codepoint <= 0x11D8E) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11D90 && codepoint <= 0x11D91) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11D93 && codepoint <= 0x11D94) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11D95) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x11D96) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11EF3 && codepoint <= 0x11EF4) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x11EF5 && codepoint <= 0x11EF6) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x16F4F) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x16F51 && codepoint <= 0x16F87) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x16F8F && codepoint <= 0x16F92) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x16FF0 && codepoint <= 0x16FF1) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1BC9E) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1E000 && codepoint <= 0x1E006) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1E008 && codepoint <= 0x1E018) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1E01B && codepoint <= 0x1E021) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1E023 && codepoint <= 0x1E024) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1E026 && codepoint <= 0x1E02A) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x1E947) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1F130 && codepoint <= 0x1F149) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1F150 && codepoint <= 0x1F169) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint >= 0x1F170 && codepoint <= 0x1F189) return Ucd_Prop_OTHER_ALPHABETIC;
	if (codepoint == 0x3006) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint == 0x3007) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint >= 0x3021 && codepoint <= 0x3029) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint >= 0x3038 && codepoint <= 0x303A) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint >= 0x3400 && codepoint <= 0x4DBF) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint >= 0x4E00 && codepoint <= 0x9FFC) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint >= 0xF900 && codepoint <= 0xFA6D) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint >= 0xFA70 && codepoint <= 0xFAD9) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint == 0x16FE4) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint >= 0x17000 && codepoint <= 0x187F7) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint >= 0x18800 && codepoint <= 0x18CD5) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint >= 0x18D00 && codepoint <= 0x18D08) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint >= 0x1B170 && codepoint <= 0x1B2FB) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint >= 0x20000 && codepoint <= 0x2A6DD) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint >= 0x2A700 && codepoint <= 0x2B734) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint >= 0x2B740 && codepoint <= 0x2B81D) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint >= 0x2B820 && codepoint <= 0x2CEA1) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint >= 0x2CEB0 && codepoint <= 0x2EBE0) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint >= 0x2F800 && codepoint <= 0x2FA1D) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint >= 0x30000 && codepoint <= 0x3134A) return Ucd_Prop_IDEOGRAPHIC;
	if (codepoint == 0x005E) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0060) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x00A8) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x00AF) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x00B4) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x00B7) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x00B8) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x02B0 && codepoint <= 0x02C1) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x02C2 && codepoint <= 0x02C5) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x02C6 && codepoint <= 0x02D1) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x02D2 && codepoint <= 0x02DF) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x02E0 && codepoint <= 0x02E4) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x02E5 && codepoint <= 0x02EB) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x02EC) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x02ED) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x02EE) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x02EF && codepoint <= 0x02FF) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x0300 && codepoint <= 0x034E) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x0350 && codepoint <= 0x0357) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x035D && codepoint <= 0x0362) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0374) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0375) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x037A) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x0384 && codepoint <= 0x0385) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x0483 && codepoint <= 0x0487) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0559) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x0591 && codepoint <= 0x05A1) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x05A3 && codepoint <= 0x05BD) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x05BF) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x05C1 && codepoint <= 0x05C2) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x05C4) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x064B && codepoint <= 0x0652) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x0657 && codepoint <= 0x0658) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x06DF && codepoint <= 0x06E0) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x06E5 && codepoint <= 0x06E6) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x06EA && codepoint <= 0x06EC) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x0730 && codepoint <= 0x074A) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x07A6 && codepoint <= 0x07B0) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x07EB && codepoint <= 0x07F3) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x07F4 && codepoint <= 0x07F5) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x0818 && codepoint <= 0x0819) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x08E3 && codepoint <= 0x08FE) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x093C) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x094D) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x0951 && codepoint <= 0x0954) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0971) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x09BC) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x09CD) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0A3C) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0A4D) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0ABC) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0ACD) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x0AFD && codepoint <= 0x0AFF) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0B3C) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0B4D) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0B55) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0BCD) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0C4D) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0CBC) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0CCD) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x0D3B && codepoint <= 0x0D3C) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0D4D) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0DCA) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x0E47 && codepoint <= 0x0E4C) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0E4E) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0EBA) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x0EC8 && codepoint <= 0x0ECC) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x0F18 && codepoint <= 0x0F19) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0F35) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0F37) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0F39) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x0F3E && codepoint <= 0x0F3F) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x0F82 && codepoint <= 0x0F84) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x0F86 && codepoint <= 0x0F87) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x0FC6) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x1037) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1039 && codepoint <= 0x103A) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1063 && codepoint <= 0x1064) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1069 && codepoint <= 0x106D) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1087 && codepoint <= 0x108C) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x108D) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x108F) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x109A && codepoint <= 0x109B) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x135D && codepoint <= 0x135F) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x17C9 && codepoint <= 0x17D3) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x17DD) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1939 && codepoint <= 0x193B) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1A75 && codepoint <= 0x1A7C) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x1A7F) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1AB0 && codepoint <= 0x1ABD) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x1B34) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x1B44) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1B6B && codepoint <= 0x1B73) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x1BAA) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x1BAB) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1C36 && codepoint <= 0x1C37) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1C78 && codepoint <= 0x1C7D) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1CD0 && codepoint <= 0x1CD2) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x1CD3) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1CD4 && codepoint <= 0x1CE0) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x1CE1) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1CE2 && codepoint <= 0x1CE8) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x1CED) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x1CF4) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x1CF7) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1CF8 && codepoint <= 0x1CF9) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1D2C && codepoint <= 0x1D6A) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1DC4 && codepoint <= 0x1DCF) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1DF5 && codepoint <= 0x1DF9) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1DFD && codepoint <= 0x1DFF) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x1FBD) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1FBF && codepoint <= 0x1FC1) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1FCD && codepoint <= 0x1FCF) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1FDD && codepoint <= 0x1FDF) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1FED && codepoint <= 0x1FEF) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1FFD && codepoint <= 0x1FFE) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x2CEF && codepoint <= 0x2CF1) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x2E2F) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x302A && codepoint <= 0x302D) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x302E && codepoint <= 0x302F) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x3099 && codepoint <= 0x309A) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x309B && codepoint <= 0x309C) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x30FC) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xA66F) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0xA67C && codepoint <= 0xA67D) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xA67F) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0xA69C && codepoint <= 0xA69D) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0xA6F0 && codepoint <= 0xA6F1) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0xA700 && codepoint <= 0xA716) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0xA717 && codepoint <= 0xA71F) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0xA720 && codepoint <= 0xA721) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xA788) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0xA789 && codepoint <= 0xA78A) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0xA7F8 && codepoint <= 0xA7F9) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xA8C4) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0xA8E0 && codepoint <= 0xA8F1) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0xA92B && codepoint <= 0xA92D) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xA92E) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xA953) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xA9B3) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xA9C0) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xA9E5) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xAA7B) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xAA7C) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xAA7D) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xAABF) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xAAC0) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xAAC1) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xAAC2) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xAAF6) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xAB5B) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0xAB5C && codepoint <= 0xAB5F) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xAB69) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0xAB6A && codepoint <= 0xAB6B) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xABEC) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xABED) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xFB1E) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0xFE20 && codepoint <= 0xFE2F) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xFF3E) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xFF40) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xFF70) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0xFF9E && codepoint <= 0xFF9F) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0xFFE3) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x102E0) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x10AE5 && codepoint <= 0x10AE6) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x10D22 && codepoint <= 0x10D23) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x10D24 && codepoint <= 0x10D27) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x10F46 && codepoint <= 0x10F50) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x110B9 && codepoint <= 0x110BA) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x11133 && codepoint <= 0x11134) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x11173) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x111C0) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x111CA && codepoint <= 0x111CC) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x11235) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x11236) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x112E9 && codepoint <= 0x112EA) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x1133C) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x1134D) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x11366 && codepoint <= 0x1136C) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x11370 && codepoint <= 0x11374) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x11442) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x11446) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x114C2 && codepoint <= 0x114C3) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x115BF && codepoint <= 0x115C0) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x1163F) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x116B6) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x116B7) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x1172B) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x11839 && codepoint <= 0x1183A) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x1193D) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x1193E) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x11943) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x119E0) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x11A34) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x11A47) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x11A99) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x11C3F) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x11D42) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x11D44 && codepoint <= 0x11D45) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x11D97) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x16AF0 && codepoint <= 0x16AF4) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x16B30 && codepoint <= 0x16B36) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x16F8F && codepoint <= 0x16F92) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x16F93 && codepoint <= 0x16F9F) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x16FF0 && codepoint <= 0x16FF1) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1D167 && codepoint <= 0x1D169) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1D16D && codepoint <= 0x1D172) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1D17B && codepoint <= 0x1D182) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1D185 && codepoint <= 0x1D18B) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1D1AA && codepoint <= 0x1D1AD) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1E130 && codepoint <= 0x1E136) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1E2EC && codepoint <= 0x1E2EF) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1E8D0 && codepoint <= 0x1E8D6) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1E944 && codepoint <= 0x1E946) return Ucd_Prop_DIACRITIC;
	if (codepoint >= 0x1E948 && codepoint <= 0x1E94A) return Ucd_Prop_DIACRITIC;
	if (codepoint == 0x00B7) return Ucd_Prop_EXTENDER;
	if (codepoint >= 0x02D0 && codepoint <= 0x02D1) return Ucd_Prop_EXTENDER;
	if (codepoint == 0x0640) return Ucd_Prop_EXTENDER;
	if (codepoint == 0x07FA) return Ucd_Prop_EXTENDER;
	if (codepoint == 0x0B55) return Ucd_Prop_EXTENDER;
	if (codepoint == 0x0E46) return Ucd_Prop_EXTENDER;
	if (codepoint == 0x0EC6) return Ucd_Prop_EXTENDER;
	if (codepoint == 0x180A) return Ucd_Prop_EXTENDER;
	if (codepoint == 0x1843) return Ucd_Prop_EXTENDER;
	if (codepoint == 0x1AA7) return Ucd_Prop_EXTENDER;
	if (codepoint == 0x1C36) return Ucd_Prop_EXTENDER;
	if (codepoint == 0x1C7B) return Ucd_Prop_EXTENDER;
	if (codepoint == 0x3005) return Ucd_Prop_EXTENDER;
	if (codepoint >= 0x3031 && codepoint <= 0x3035) return Ucd_Prop_EXTENDER;
	if (codepoint >= 0x309D && codepoint <= 0x309E) return Ucd_Prop_EXTENDER;
	if (codepoint >= 0x30FC && codepoint <= 0x30FE) return Ucd_Prop_EXTENDER;
	if (codepoint == 0xA015) return Ucd_Prop_EXTENDER;
	if (codepoint == 0xA60C) return Ucd_Prop_EXTENDER;
	if (codepoint == 0xA9CF) return Ucd_Prop_EXTENDER;
	if (codepoint == 0xA9E6) return Ucd_Prop_EXTENDER;
	if (codepoint == 0xAA70) return Ucd_Prop_EXTENDER;
	if (codepoint == 0xAADD) return Ucd_Prop_EXTENDER;
	if (codepoint >= 0xAAF3 && codepoint <= 0xAAF4) return Ucd_Prop_EXTENDER;
	if (codepoint == 0xFF70) return Ucd_Prop_EXTENDER;
	if (codepoint == 0x1135D) return Ucd_Prop_EXTENDER;
	if (codepoint >= 0x115C6 && codepoint <= 0x115C8) return Ucd_Prop_EXTENDER;
	if (codepoint == 0x11A98) return Ucd_Prop_EXTENDER;
	if (codepoint >= 0x16B42 && codepoint <= 0x16B43) return Ucd_Prop_EXTENDER;
	if (codepoint >= 0x16FE0 && codepoint <= 0x16FE1) return Ucd_Prop_EXTENDER;
	if (codepoint == 0x16FE3) return Ucd_Prop_EXTENDER;
	if (codepoint >= 0x1E13C && codepoint <= 0x1E13D) return Ucd_Prop_EXTENDER;
	if (codepoint >= 0x1E944 && codepoint <= 0x1E946) return Ucd_Prop_EXTENDER;
	if (codepoint == 0x00AA) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint == 0x00BA) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint >= 0x02B0 && codepoint <= 0x02B8) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint >= 0x02C0 && codepoint <= 0x02C1) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint >= 0x02E0 && codepoint <= 0x02E4) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint == 0x0345) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint == 0x037A) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint >= 0x1D2C && codepoint <= 0x1D6A) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint == 0x1D78) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint >= 0x1D9B && codepoint <= 0x1DBF) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint == 0x2071) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint == 0x207F) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint >= 0x2090 && codepoint <= 0x209C) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint >= 0x2170 && codepoint <= 0x217F) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint >= 0x24D0 && codepoint <= 0x24E9) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint >= 0x2C7C && codepoint <= 0x2C7D) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint >= 0xA69C && codepoint <= 0xA69D) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint == 0xA770) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint >= 0xA7F8 && codepoint <= 0xA7F9) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint >= 0xAB5C && codepoint <= 0xAB5F) return Ucd_Prop_OTHER_LOWERCASE;
	if (codepoint >= 0x2160 && codepoint <= 0x216F) return Ucd_Prop_OTHER_UPPERCASE;
	if (codepoint >= 0x24B6 && codepoint <= 0x24CF) return Ucd_Prop_OTHER_UPPERCASE;
	if (codepoint >= 0x1F130 && codepoint <= 0x1F149) return Ucd_Prop_OTHER_UPPERCASE;
	if (codepoint >= 0x1F150 && codepoint <= 0x1F169) return Ucd_Prop_OTHER_UPPERCASE;
	if (codepoint >= 0x1F170 && codepoint <= 0x1F189) return Ucd_Prop_OTHER_UPPERCASE;
	if (codepoint >= 0xFDD0 && codepoint <= 0xFDEF) return Ucd_Prop_NONCHARACTER_CODE_POINT;
	if (codepoint >= 0xFFFE && codepoint <= 0xFFFF) return Ucd_Prop_NONCHARACTER_CODE_POINT;
	if (codepoint >= 0x1FFFE && codepoint <= 0x1FFFF) return Ucd_Prop_NONCHARACTER_CODE_POINT;
	if (codepoint >= 0x2FFFE && codepoint <= 0x2FFFF) return Ucd_Prop_NONCHARACTER_CODE_POINT;
	if (codepoint >= 0x3FFFE && codepoint <= 0x3FFFF) return Ucd_Prop_NONCHARACTER_CODE_POINT;
	if (codepoint >= 0x4FFFE && codepoint <= 0x4FFFF) return Ucd_Prop_NONCHARACTER_CODE_POINT;
	if (codepoint >= 0x5FFFE && codepoint <= 0x5FFFF) return Ucd_Prop_NONCHARACTER_CODE_POINT;
	if (codepoint >= 0x6FFFE && codepoint <= 0x6FFFF) return Ucd_Prop_NONCHARACTER_CODE_POINT;
	if (codepoint >= 0x7FFFE && codepoint <= 0x7FFFF) return Ucd_Prop_NONCHARACTER_CODE_POINT;
	if (codepoint >= 0x8FFFE && codepoint <= 0x8FFFF) return Ucd_Prop_NONCHARACTER_CODE_POINT;
	if (codepoint >= 0x9FFFE && codepoint <= 0x9FFFF) return Ucd_Prop_NONCHARACTER_CODE_POINT;
	if (codepoint >= 0xAFFFE && codepoint <= 0xAFFFF) return Ucd_Prop_NONCHARACTER_CODE_POINT;
	if (codepoint >= 0xBFFFE && codepoint <= 0xBFFFF) return Ucd_Prop_NONCHARACTER_CODE_POINT;
	if (codepoint >= 0xCFFFE && codepoint <= 0xCFFFF) return Ucd_Prop_NONCHARACTER_CODE_POINT;
	if (codepoint >= 0xDFFFE && codepoint <= 0xDFFFF) return Ucd_Prop_NONCHARACTER_CODE_POINT;
	if (codepoint >= 0xEFFFE && codepoint <= 0xEFFFF) return Ucd_Prop_NONCHARACTER_CODE_POINT;
	if (codepoint >= 0xFFFFE && codepoint <= 0xFFFFF) return Ucd_Prop_NONCHARACTER_CODE_POINT;
	if (codepoint >= 0x10FFFE && codepoint <= 0x10FFFF) return Ucd_Prop_NONCHARACTER_CODE_POINT;
	if (codepoint == 0x09BE) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x09D7) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x0B3E) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x0B57) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x0BBE) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x0BD7) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x0CC2) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint >= 0x0CD5 && codepoint <= 0x0CD6) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x0D3E) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x0D57) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x0DCF) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x0DDF) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x1B35) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x200C) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint >= 0x302E && codepoint <= 0x302F) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint >= 0xFF9E && codepoint <= 0xFF9F) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x1133E) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x11357) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x114B0) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x114BD) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x115AF) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x11930) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint == 0x1D165) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint >= 0x1D16E && codepoint <= 0x1D172) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint >= 0xE0020 && codepoint <= 0xE007F) return Ucd_Prop_OTHER_GRAPHEME_EXTEND;
	if (codepoint >= 0x2FF0 && codepoint <= 0x2FF1) return Ucd_Prop_IDS_BINARY_OPERATOR;
	if (codepoint >= 0x2FF4 && codepoint <= 0x2FFB) return Ucd_Prop_IDS_BINARY_OPERATOR;
	if (codepoint >= 0x2FF2 && codepoint <= 0x2FF3) return Ucd_Prop_IDS_TRINARY_OPERATOR;
	if (codepoint >= 0x2E80 && codepoint <= 0x2E99) return Ucd_Prop_RADICAL;
	if (codepoint >= 0x2E9B && codepoint <= 0x2EF3) return Ucd_Prop_RADICAL;
	if (codepoint >= 0x2F00 && codepoint <= 0x2FD5) return Ucd_Prop_RADICAL;
	if (codepoint >= 0x3400 && codepoint <= 0x4DBF) return Ucd_Prop_UNIFIED_IDEOGRAPH;
	if (codepoint >= 0x4E00 && codepoint <= 0x9FFC) return Ucd_Prop_UNIFIED_IDEOGRAPH;
	if (codepoint >= 0xFA0E && codepoint <= 0xFA0F) return Ucd_Prop_UNIFIED_IDEOGRAPH;
	if (codepoint == 0xFA11) return Ucd_Prop_UNIFIED_IDEOGRAPH;
	if (codepoint >= 0xFA13 && codepoint <= 0xFA14) return Ucd_Prop_UNIFIED_IDEOGRAPH;
	if (codepoint == 0xFA1F) return Ucd_Prop_UNIFIED_IDEOGRAPH;
	if (codepoint == 0xFA21) return Ucd_Prop_UNIFIED_IDEOGRAPH;
	if (codepoint >= 0xFA23 && codepoint <= 0xFA24) return Ucd_Prop_UNIFIED_IDEOGRAPH;
	if (codepoint >= 0xFA27 && codepoint <= 0xFA29) return Ucd_Prop_UNIFIED_IDEOGRAPH;
	if (codepoint >= 0x20000 && codepoint <= 0x2A6DD) return Ucd_Prop_UNIFIED_IDEOGRAPH;
	if (codepoint >= 0x2A700 && codepoint <= 0x2B734) return Ucd_Prop_UNIFIED_IDEOGRAPH;
	if (codepoint >= 0x2B740 && codepoint <= 0x2B81D) return Ucd_Prop_UNIFIED_IDEOGRAPH;
	if (codepoint >= 0x2B820 && codepoint <= 0x2CEA1) return Ucd_Prop_UNIFIED_IDEOGRAPH;
	if (codepoint >= 0x2CEB0 && codepoint <= 0x2EBE0) return Ucd_Prop_UNIFIED_IDEOGRAPH;
	if (codepoint >= 0x30000 && codepoint <= 0x3134A) return Ucd_Prop_UNIFIED_IDEOGRAPH;
	if (codepoint == 0x034F) return Ucd_Prop_OTHER_DEFAULT_IGNORABLE_CODE_POINT;
	if (codepoint >= 0x115F && codepoint <= 0x1160) return Ucd_Prop_OTHER_DEFAULT_IGNORABLE_CODE_POINT;
	if (codepoint >= 0x17B4 && codepoint <= 0x17B5) return Ucd_Prop_OTHER_DEFAULT_IGNORABLE_CODE_POINT;
	if (codepoint == 0x2065) return Ucd_Prop_OTHER_DEFAULT_IGNORABLE_CODE_POINT;
	if (codepoint == 0x3164) return Ucd_Prop_OTHER_DEFAULT_IGNORABLE_CODE_POINT;
	if (codepoint == 0xFFA0) return Ucd_Prop_OTHER_DEFAULT_IGNORABLE_CODE_POINT;
	if (codepoint >= 0xFFF0 && codepoint <= 0xFFF8) return Ucd_Prop_OTHER_DEFAULT_IGNORABLE_CODE_POINT;
	if (codepoint == 0xE0000) return Ucd_Prop_OTHER_DEFAULT_IGNORABLE_CODE_POINT;
	if (codepoint >= 0xE0002 && codepoint <= 0xE001F) return Ucd_Prop_OTHER_DEFAULT_IGNORABLE_CODE_POINT;
	if (codepoint >= 0xE0080 && codepoint <= 0xE00FF) return Ucd_Prop_OTHER_DEFAULT_IGNORABLE_CODE_POINT;
	if (codepoint >= 0xE01F0 && codepoint <= 0xE0FFF) return Ucd_Prop_OTHER_DEFAULT_IGNORABLE_CODE_POINT;
	if (codepoint == 0x0149) return Ucd_Prop_DEPRECATED;
	if (codepoint == 0x0673) return Ucd_Prop_DEPRECATED;
	if (codepoint == 0x0F77) return Ucd_Prop_DEPRECATED;
	if (codepoint == 0x0F79) return Ucd_Prop_DEPRECATED;
	if (codepoint >= 0x17A3 && codepoint <= 0x17A4) return Ucd_Prop_DEPRECATED;
	if (codepoint >= 0x206A && codepoint <= 0x206F) return Ucd_Prop_DEPRECATED;
	if (codepoint == 0x2329) return Ucd_Prop_DEPRECATED;
	if (codepoint == 0x232A) return Ucd_Prop_DEPRECATED;
	if (codepoint == 0xE0001) return Ucd_Prop_DEPRECATED;
	if (codepoint >= 0x0069 && codepoint <= 0x006A) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint == 0x012F) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint == 0x0249) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint == 0x0268) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint == 0x029D) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint == 0x02B2) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint == 0x03F3) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint == 0x0456) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint == 0x0458) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint == 0x1D62) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint == 0x1D96) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint == 0x1DA4) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint == 0x1DA8) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint == 0x1E2D) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint == 0x1ECB) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint == 0x2071) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint >= 0x2148 && codepoint <= 0x2149) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint == 0x2C7C) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint >= 0x1D422 && codepoint <= 0x1D423) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint >= 0x1D456 && codepoint <= 0x1D457) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint >= 0x1D48A && codepoint <= 0x1D48B) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint >= 0x1D4BE && codepoint <= 0x1D4BF) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint >= 0x1D4F2 && codepoint <= 0x1D4F3) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint >= 0x1D526 && codepoint <= 0x1D527) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint >= 0x1D55A && codepoint <= 0x1D55B) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint >= 0x1D58E && codepoint <= 0x1D58F) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint >= 0x1D5C2 && codepoint <= 0x1D5C3) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint >= 0x1D5F6 && codepoint <= 0x1D5F7) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint >= 0x1D62A && codepoint <= 0x1D62B) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint >= 0x1D65E && codepoint <= 0x1D65F) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint >= 0x1D692 && codepoint <= 0x1D693) return Ucd_Prop_SOFT_DOTTED;
	if (codepoint >= 0x0E40 && codepoint <= 0x0E44) return Ucd_Prop_LOGICAL_ORDER_EXCEPTION;
	if (codepoint >= 0x0EC0 && codepoint <= 0x0EC4) return Ucd_Prop_LOGICAL_ORDER_EXCEPTION;
	if (codepoint >= 0x19B5 && codepoint <= 0x19B7) return Ucd_Prop_LOGICAL_ORDER_EXCEPTION;
	if (codepoint == 0x19BA) return Ucd_Prop_LOGICAL_ORDER_EXCEPTION;
	if (codepoint >= 0xAAB5 && codepoint <= 0xAAB6) return Ucd_Prop_LOGICAL_ORDER_EXCEPTION;
	if (codepoint == 0xAAB9) return Ucd_Prop_LOGICAL_ORDER_EXCEPTION;
	if (codepoint >= 0xAABB && codepoint <= 0xAABC) return Ucd_Prop_LOGICAL_ORDER_EXCEPTION;
	if (codepoint >= 0x1885 && codepoint <= 0x1886) return Ucd_Prop_OTHER_ID_START;
	if (codepoint == 0x2118) return Ucd_Prop_OTHER_ID_START;
	if (codepoint == 0x212E) return Ucd_Prop_OTHER_ID_START;
	if (codepoint >= 0x309B && codepoint <= 0x309C) return Ucd_Prop_OTHER_ID_START;
	if (codepoint == 0x00B7) return Ucd_Prop_OTHER_ID_CONTINUE;
	if (codepoint == 0x0387) return Ucd_Prop_OTHER_ID_CONTINUE;
	if (codepoint >= 0x1369 && codepoint <= 0x1371) return Ucd_Prop_OTHER_ID_CONTINUE;
	if (codepoint == 0x19DA) return Ucd_Prop_OTHER_ID_CONTINUE;
	if (codepoint == 0x0021) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x002E) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x003F) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x0589) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x061E && codepoint <= 0x061F) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x06D4) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x0700 && codepoint <= 0x0702) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x07F9) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x0837) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x0839) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x083D && codepoint <= 0x083E) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x0964 && codepoint <= 0x0965) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x104A && codepoint <= 0x104B) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x1362) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x1367 && codepoint <= 0x1368) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x166E) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x1735 && codepoint <= 0x1736) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x1803) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x1809) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x1944 && codepoint <= 0x1945) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x1AA8 && codepoint <= 0x1AAB) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x1B5A && codepoint <= 0x1B5B) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x1B5E && codepoint <= 0x1B5F) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x1C3B && codepoint <= 0x1C3C) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x1C7E && codepoint <= 0x1C7F) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x203C && codepoint <= 0x203D) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x2047 && codepoint <= 0x2049) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x2E2E) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x2E3C) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x3002) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0xA4FF) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0xA60E && codepoint <= 0xA60F) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0xA6F3) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0xA6F7) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0xA876 && codepoint <= 0xA877) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0xA8CE && codepoint <= 0xA8CF) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0xA92F) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0xA9C8 && codepoint <= 0xA9C9) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0xAA5D && codepoint <= 0xAA5F) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0xAAF0 && codepoint <= 0xAAF1) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0xABEB) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0xFE52) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0xFE56 && codepoint <= 0xFE57) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0xFF01) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0xFF0E) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0xFF1F) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0xFF61) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x10A56 && codepoint <= 0x10A57) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x10F55 && codepoint <= 0x10F59) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x11047 && codepoint <= 0x11048) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x110BE && codepoint <= 0x110C1) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x11141 && codepoint <= 0x11143) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x111C5 && codepoint <= 0x111C6) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x111CD) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x111DE && codepoint <= 0x111DF) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x11238 && codepoint <= 0x11239) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x1123B && codepoint <= 0x1123C) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x112A9) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x1144B && codepoint <= 0x1144C) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x115C2 && codepoint <= 0x115C3) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x115C9 && codepoint <= 0x115D7) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x11641 && codepoint <= 0x11642) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x1173C && codepoint <= 0x1173E) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x11944) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x11946) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x11A42 && codepoint <= 0x11A43) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x11A9B && codepoint <= 0x11A9C) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x11C41 && codepoint <= 0x11C42) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x11EF7 && codepoint <= 0x11EF8) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x16A6E && codepoint <= 0x16A6F) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x16AF5) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x16B37 && codepoint <= 0x16B38) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x16B44) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x16E98) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x1BC9F) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint == 0x1DA88) return Ucd_Prop_SENTENCE_TERMINAL;
	if (codepoint >= 0x180B && codepoint <= 0x180D) return Ucd_Prop_VARIATION_SELECTOR;
	if (codepoint >= 0xFE00 && codepoint <= 0xFE0F) return Ucd_Prop_VARIATION_SELECTOR;
	if (codepoint >= 0xE0100 && codepoint <= 0xE01EF) return Ucd_Prop_VARIATION_SELECTOR;
	if (codepoint >= 0x0009 && codepoint <= 0x000D) return Ucd_Prop_PATTERN_WHITE_SPACE;
	if (codepoint == 0x0020) return Ucd_Prop_PATTERN_WHITE_SPACE;
	if (codepoint == 0x0085) return Ucd_Prop_PATTERN_WHITE_SPACE;
	if (codepoint >= 0x200E && codepoint <= 0x200F) return Ucd_Prop_PATTERN_WHITE_SPACE;
	if (codepoint == 0x2028) return Ucd_Prop_PATTERN_WHITE_SPACE;
	if (codepoint == 0x2029) return Ucd_Prop_PATTERN_WHITE_SPACE;
	if (codepoint >= 0x0021 && codepoint <= 0x0023) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x0024) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x0025 && codepoint <= 0x0027) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x0028) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x0029) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x002A) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x002B) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x002C) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x002D) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x002E && codepoint <= 0x002F) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x003A && codepoint <= 0x003B) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x003C && codepoint <= 0x003E) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x003F && codepoint <= 0x0040) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x005B) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x005C) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x005D) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x005E) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x0060) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x007B) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x007C) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x007D) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x007E) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x00A1) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x00A2 && codepoint <= 0x00A5) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x00A6) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x00A7) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x00A9) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x00AB) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x00AC) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x00AE) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x00B0) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x00B1) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x00B6) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x00BB) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x00BF) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x00D7) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x00F7) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2010 && codepoint <= 0x2015) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2016 && codepoint <= 0x2017) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2018) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2019) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x201A) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x201B && codepoint <= 0x201C) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x201D) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x201E) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x201F) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2020 && codepoint <= 0x2027) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2030 && codepoint <= 0x2038) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2039) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x203A) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x203B && codepoint <= 0x203E) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2041 && codepoint <= 0x2043) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2044) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2045) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2046) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2047 && codepoint <= 0x2051) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2052) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2053) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2055 && codepoint <= 0x205E) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2190 && codepoint <= 0x2194) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2195 && codepoint <= 0x2199) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x219A && codepoint <= 0x219B) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x219C && codepoint <= 0x219F) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x21A0) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x21A1 && codepoint <= 0x21A2) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x21A3) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x21A4 && codepoint <= 0x21A5) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x21A6) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x21A7 && codepoint <= 0x21AD) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x21AE) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x21AF && codepoint <= 0x21CD) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x21CE && codepoint <= 0x21CF) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x21D0 && codepoint <= 0x21D1) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x21D2) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x21D3) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x21D4) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x21D5 && codepoint <= 0x21F3) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x21F4 && codepoint <= 0x22FF) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2300 && codepoint <= 0x2307) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2308) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2309) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x230A) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x230B) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x230C && codepoint <= 0x231F) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2320 && codepoint <= 0x2321) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2322 && codepoint <= 0x2328) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2329) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x232A) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x232B && codepoint <= 0x237B) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x237C) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x237D && codepoint <= 0x239A) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x239B && codepoint <= 0x23B3) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x23B4 && codepoint <= 0x23DB) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x23DC && codepoint <= 0x23E1) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x23E2 && codepoint <= 0x2426) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2427 && codepoint <= 0x243F) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2440 && codepoint <= 0x244A) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x244B && codepoint <= 0x245F) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2500 && codepoint <= 0x25B6) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x25B7) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x25B8 && codepoint <= 0x25C0) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x25C1) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x25C2 && codepoint <= 0x25F7) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x25F8 && codepoint <= 0x25FF) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2600 && codepoint <= 0x266E) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x266F) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2670 && codepoint <= 0x2767) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2768) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2769) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x276A) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x276B) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x276C) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x276D) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x276E) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x276F) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2770) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2771) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2772) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2773) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2774) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2775) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2794 && codepoint <= 0x27BF) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x27C0 && codepoint <= 0x27C4) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x27C5) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x27C6) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x27C7 && codepoint <= 0x27E5) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x27E6) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x27E7) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x27E8) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x27E9) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x27EA) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x27EB) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x27EC) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x27ED) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x27EE) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x27EF) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x27F0 && codepoint <= 0x27FF) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2800 && codepoint <= 0x28FF) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2900 && codepoint <= 0x2982) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2983) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2984) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2985) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2986) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2987) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2988) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2989) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x298A) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x298B) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x298C) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x298D) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x298E) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x298F) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2990) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2991) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2992) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2993) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2994) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2995) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2996) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2997) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2998) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2999 && codepoint <= 0x29D7) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x29D8) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x29D9) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x29DA) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x29DB) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x29DC && codepoint <= 0x29FB) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x29FC) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x29FD) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x29FE && codepoint <= 0x2AFF) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2B00 && codepoint <= 0x2B2F) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2B30 && codepoint <= 0x2B44) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2B45 && codepoint <= 0x2B46) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2B47 && codepoint <= 0x2B4C) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2B4D && codepoint <= 0x2B73) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2B74 && codepoint <= 0x2B75) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2B76 && codepoint <= 0x2B95) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2B96) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2B97 && codepoint <= 0x2BFF) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2E00 && codepoint <= 0x2E01) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E02) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E03) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E04) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E05) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2E06 && codepoint <= 0x2E08) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E09) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E0A) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E0B) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E0C) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E0D) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2E0E && codepoint <= 0x2E16) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E17) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2E18 && codepoint <= 0x2E19) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E1A) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E1B) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E1C) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E1D) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2E1E && codepoint <= 0x2E1F) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E20) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E21) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E22) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E23) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E24) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E25) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E26) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E27) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E28) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E29) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2E2A && codepoint <= 0x2E2E) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E2F) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2E30 && codepoint <= 0x2E39) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2E3A && codepoint <= 0x2E3B) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2E3C && codepoint <= 0x2E3F) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E40) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E41) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E42) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2E43 && codepoint <= 0x2E4F) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2E50 && codepoint <= 0x2E51) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x2E52) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x2E53 && codepoint <= 0x2E7F) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x3001 && codepoint <= 0x3003) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x3008) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x3009) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x300A) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x300B) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x300C) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x300D) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x300E) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x300F) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x3010) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x3011) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x3012 && codepoint <= 0x3013) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x3014) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x3015) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x3016) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x3017) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x3018) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x3019) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x301A) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x301B) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x301C) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x301D) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x301E && codepoint <= 0x301F) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x3020) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0x3030) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0xFD3E) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint == 0xFD3F) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0xFE45 && codepoint <= 0xFE46) return Ucd_Prop_PATTERN_SYNTAX;
	if (codepoint >= 0x0600 && codepoint <= 0x0605) return Ucd_Prop_PREPENDED_CONCATENATION_MARK;
	if (codepoint == 0x06DD) return Ucd_Prop_PREPENDED_CONCATENATION_MARK;
	if (codepoint == 0x070F) return Ucd_Prop_PREPENDED_CONCATENATION_MARK;
	if (codepoint == 0x08E2) return Ucd_Prop_PREPENDED_CONCATENATION_MARK;
	if (codepoint == 0x110BD) return Ucd_Prop_PREPENDED_CONCATENATION_MARK;
	if (codepoint == 0x110CD) return Ucd_Prop_PREPENDED_CONCATENATION_MARK;
	if (codepoint >= 0x1F1E6 && codepoint <= 0x1F1FF) return Ucd_Prop_REGIONAL_INDICATOR;

	return Ucd_Prop_UNKNOWN;
}
