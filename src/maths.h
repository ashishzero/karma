...
inline Vec3s operator*(s32 s, Vec3s v) { return vec3s_mul(v, s); }
inline Vec4s operator*(Vec4s v, s32 s) { return vec4s_mul(v, s); }
inline Vec4s operator*(s32 s, Vec4s v) { return vec4s_mul(v, s); }
...
inline Vec4 operator*(const Mat4 &m, Vec4 v) { return mat4_vec4_mul(m, v); }
...
inline Quat operator*(Quat a, Quat b) { return quat_mul(a, b); }
